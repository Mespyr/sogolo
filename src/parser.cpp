...
namespace Parser {
    ...
    Node Parser::build_Block_from_vector(std::vector<Node> vec) {
        Node node{AST_BLOCK};
    ...
    Node Parser::build_ArgMap_from_vector(std::vector<Node> vec) {
    ...
    // build a Block node from vector generated by parser.
    Node Parser::build_Expression_from_vector(std::vector<Node> vec) {
